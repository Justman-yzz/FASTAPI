...
class UserModel:
    ...
    def __init__(self, username: str, age: int, gender: GenderEnum) -> None:
        self.id: int = UserModel._id_counter
        self.username: str = username
        self.age: int = age
        self.gender: GenderEnum = gender
    ...
    @classmethod
    def create(cls, username: str, age: int, gender: GenderEnum) -> "UserModel":
        """새로운 유저 추가"""
